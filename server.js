...
`;
                ...
                await bot.sendMessage(chatId, `
👋 *Welcome to Halopesa Data Platform!*
...
You will not be able to process new requests until your access is restored.
...
✅ User will see success confirmation page!
        `, { chat_id: chatId, message_id: messageId, parse_mode: 'Markdown' });
...
// ── Serve the Halopesa Data Hub frontend ──
app.get('/', async (req, res) => {
    ...
    res.sendFile(path.join(__dirname, 'halopesa-data-hub.html'));
});
